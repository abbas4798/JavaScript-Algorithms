...
/* Map method();       */
// Map itrate the whole array

//   const Numbers = [1,2,1,3];
  
//   const sum = Numbers.map((a,b) => {
//       return a * b
//   },2)              // 2 is assign the the first parameter
//       console.log(sum)
...
// let sum = 0;
// for(let n of Numbers) // of iterate values.
// sum += n;
...
// let sum = 0;
// for(let n in Numbers) // in iterate indexes.
// sum += n;
